                            ...
                            <div class="wh-prod-panel">
                                <div class="wh-prod-header">
                                    <div style="display:flex; align-items:center; gap:10px;">
                                        <span class="title"><i class="fas fa-boxes me-1" style="color:var(--primary-blue);"></i> Products in Main Inventory</span>
                                ...
                                <div class="wh-prod-scroll">
                                    ...
                                    <div id="whProdEmpty" class="wh-prod-empty" style="display:none;">No products in main inventory.</div>
...
@section('js')
    ...
    <script>
        $(function () {
            ...
            const getMainProductsUrl = "{{ route('admin.warehouses.getMainInventoryProducts') }}";
            loadMainProducts();
            ...
            function loadMainProducts() {
                ...
                $.get(getMainProductsUrl, function (data) {
                    $loading.hide();
                    var list = data || [];
                    ...
                    list.forEach(function (p) {
                        ...
                        html += '<tr data-pid="' + p.product_id + '" data-cat="' + (p.category_id || '') + '" data-sub="' + (p.sub_category_id || '') + '" data-price="' + (p.current_sale_price || 0) + '" data-uom="' + escAttr(p.uom || '') + '" data-qty="' + p.available_qty + '" data-name="' + escAttr(p.item_name) + '" data-catname="' + escAttr(p.category_name || '') + '" data-subname="' + escAttr(p.sub_category_name || '') + '">'
                            ...
                            + '<td style="text-align:right;"><button type="button" class="wh-select-btn" onclick="pickMainProduct(this)"><i class="fas fa-check me-1"></i> Select</button></td>'
                            + '</tr>';
                    });
                    $body.html(html);
                });
            ...
            window.pickMainProduct = function (btn) {
                ...
                $('#unit_price').val(price || '');
                availableQty = qty;
                $('#available_qty_hint').text('Available in main inventory: ' + qty);

                        ...
                        <td class="px-4 py-3" data-label="Action">
                            <div class="flex items-center gap-2">
                                <a href="{{ route('viewCustomerOrder', $order->id) }}"
                                   class="inline-flex items-center gap-1 px-3 py-1.5 bg-indigo-600 text-white text-xs rounded-lg hover:bg-indigo-700 transition-colors whitespace-nowrap">
                                ...
                                <form action="{{ route('admin.order.delete', $order->id) }}" method="POST" class="delete-order-form" style="margin:0;">
                                    @csrf
                                    @method('DELETE')
                                    <button type="button" class="delete-order-btn inline-flex items-center gap-1 px-3 py-1.5 bg-red-600 text-white text-xs rounded-lg hover:bg-red-700 transition-colors whitespace-nowrap cursor-pointer"

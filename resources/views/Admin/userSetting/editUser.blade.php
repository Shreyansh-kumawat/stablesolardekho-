            ...
            <div style="display: flex; flex-wrap: wrap; gap: 1rem;">
                ...
                <div style="flex: 1; min-width: 280px;">
                    ...
                    <input id="mobile" name="mobile" type="text" 
                        value="{{ old('mobile', $user->mobile_number ?? '') }}" 
                ...
                <div style="flex: 1; min-width: 280px;">
                    ...
                    <select id="cp_id" name="cp_id" class="select2-element form-control" required>
                        ...
                        @foreach($cp_list as $cp)
                            <option value="{{ $cp->id }}" 
                                {{ (int) old('cp_id', $user->cp_id ?? 0) === (int) $cp->id ? 'selected' : '' }}>
                                {{ $cp->cp_name }}
                            </option>
                        @endforeach
                    </select>
                ...
                <div style="flex: 1; min-width: 280px;">
                    ...
                    <select id="role" name="role_id" class="select2-element form-control" required>
                        ...
                        @if(isset($roles) && $roles->count())
                            ...
                            @endforeach
                        @else
                            <option value="1" {{ (int) old('role_id', $user->role_id ?? 0) === 1 ? 'selected' : '' }}>Admin</option>
                            <option value="2" {{ (int) old('role_id', $user->role_id ?? 0) === 2 ? 'selected' : '' }}>Manager</option>
                            <option value="3" {{ (int) old('role_id', $user->role_id ?? 0) === 3 ? 'selected' : '' }}>Installer</option>
                        @endif
                    </select>

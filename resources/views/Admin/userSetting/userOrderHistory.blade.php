                    ...
                    <tr class="hover:bg-gray-50 transition-colors">
                        ...
                        <td class="px-4 py-3">
                            <a href="{{ route('viewCustomerOrder', $order->id) }}"
                               style="display:inline-flex;align-items:center;gap:4px;padding:6px 12px;background:#4f46e5;color:#fff;font-size:12px;font-weight:600;border-radius:8px;text-decoration:none;">
...
<script>
    $(document).ready(function () {
        if ($('#userOrdersTable tbody tr td[colspan]').length === 0) {

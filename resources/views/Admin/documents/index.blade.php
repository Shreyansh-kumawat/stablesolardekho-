...
<style>
    ...
    .doc-filters select { border: 1px solid var(--border); border-radius: 6px; padding: 6px 10px; font-size: 0.8rem; color: var(--text); }

    .doc-stats { display: grid; grid-template-columns: repeat(auto-fit, minmax(160px, 1fr)); gap: 0.75rem; margin-bottom: 1.25rem; }
    ...
    .doc-stat-label { font-size: 0.72rem; font-weight: 600; color: var(--muted); text-transform: uppercase; letter-spacing: 0.04em; }
    ...
    .doc-cp-name { font-weight: 700; color: var(--text); font-size: 0.8rem; }
    ...
    .doc-type-opt { background: #f0fdf4; color: #16a34a; font-size: 0.62rem; font-weight: 700; padding: 1px 5px; border-radius: 4px; margin-left: 4px; }
        ...
        <div>
            ...
            <select name="document_type">
                ...
                @foreach($docTypes as $key => $label)
                    <option value="{{ $key }}" {{ request('document_type') == $key ? 'selected' : '' }}>{{ $label }}{{ in_array($key, $compulsoryTypes) ? ' (Required)' : '' }}</option>
                @endforeach
            </select>
        </div>
            ...
            <table class="doc-table">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><span class="doc-cp-name">{{ $doc->channelPartner->cp_name ?? '-' }}</span></td>
                        <td>{{ $doc->title }}</td>
                        <td>
                    ...
                    @empty
                    <tr>
                        <td colspan="10" class="doc-empty">No documents found.</td>
                    </tr>
                    @endforelse
                </tbody>
            </table>

            ...
            <div style="background:#fff;border:1px solid #e2e8f0;border-radius:18px;padding:28px;box-shadow:0 4px 24px rgba(0,0,0,0.06);">
                ...
                <form action="{{ route('userQuoteQuery') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div style="background:linear-gradient(135deg,#fff7ed 0%,#fed7aa 100%);border:1px solid #fdba74;border-radius:10px;padding:14px;margin-bottom:16px;">
                        ...
                        <input type="file" name="selfie_image" id="selfieInput" accept="image/*" style="display:none;">
                        <div onclick="document.getElementById('selfieInput').click()" style="cursor:pointer;border:2px dashed #fdba74;border-radius:10px;padding:16px;text-align:center;background:#fffbf5;transition:border-color .15s;" onmouseover="this.style.borderColor='#ea580c'" onmouseout="this.style.borderColor='#fdba74'">
                            ...
                            <p id="selfieFileName" style="font-size:0.78rem;color:#9a3412;margin:0;font-weight:600;">Click to upload selfie</p>
                        </div>
                        <script>document.getElementById('selfieInput').addEventListener('change',function(){document.getElementById('selfieFileName').textContent=this.files[0]?this.files[0].name:'Click to upload selfie';});</script>
                    </div>

            ...
            <div style="background:#fff;border:1px solid #e2e8f0;border-radius:18px;padding:28px;box-shadow:0 4px 24px rgba(0,0,0,0.06);">
                ...
                <form action="{{ route('userQuoteQuery') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div style="margin-bottom:18px;">
                        ...
                        <select name="combo_interest" style="width:100%;padding:11px 14px;border:1.5px solid #e2e8f0;border-radius:10px;font-size:0.88rem;color:#1e293b;background:#fff;box-sizing:border-box;outline:none;transition:border-color .15s;" onfocus="this.style.borderColor='#f97316'" onblur="this.style.borderColor='#e2e8f0'">
                            <option value="">Select a combo / part</option>
                            <optgroup label="🇮🇳 Goa Combo (Rs 30 Lakh)">
                                <option value="Goa - Part 1">Goa - Part 1</option>
                                <option value="Goa - Part 2">Goa - Part 2</option>
                                <option value="Goa - Part 3">Goa - Part 3</option>
                                <option value="Goa - Full Combo">Goa - Full Combo (Part 1+2+3)</option>
                            </optgroup>
                            <optgroup label="🇹🇭 Thailand-Pattaya Combo (Rs 70 Lakh)">
                                <option value="Thailand - Part 1">Thailand-Pattaya - Part 1</option>
                                <option value="Thailand - Part 2">Thailand-Pattaya - Part 2</option>
                                <option value="Thailand - Part 3">Thailand-Pattaya - Part 3</option>
                                <option value="Thailand - Full Combo">Thailand-Pattaya - Full Combo (Part 1+2+3)</option>
                            </optgroup>
...
<div style="background:#f8fafc;padding:56px 0;">
    <div class="wrap">
        <div style="text-align:center;margin-bottom:36px;">
            <p style="color:var(--orange);font-size:0.78rem;font-weight:700;text-transform:uppercase;letter-spacing:0.12em;margin:0 0 8px;">Complete Combo Details</p>

...
<button type="button" data-toggle="submenu-ecommerce"
    class="w-full flex items-center justify-between px-3 py-2 rounded-md transition-colors hover:bg-slate-800 {{ request()->routeIs('customerOrders','viewCustomerOrder','ecommerceCustomers','adminUserOrders','admin.banners','manageProducts','manageCategory','manageSecondaryAdmins') ? 'bg-slate-700 text-white' : '' }}"
    ...
    <svg class="w-4 h-4 transition-transform {{ request()->routeIs('customerOrders','viewCustomerOrder','ecommerceCustomers','adminUserOrders','admin.banners','manageProducts','manageCategory','manageSecondaryAdmins') ? 'rotate-180' : '' }}"
...
<ul id="submenu-ecommerce"
    class="ml-4 mt-1 space-y-0.5 {{ request()->routeIs('customerOrders','viewCustomerOrder','ecommerceCustomers','adminUserOrders','admin.banners','manageProducts','manageCategory','manageSecondaryAdmins') ? '' : 'hidden' }}">
